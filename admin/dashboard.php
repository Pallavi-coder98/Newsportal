...
<html lang="en">
    <head>
        ...
        <!-- App title -->
        <title>The Times of Jhansi | Dashboard</title>
        ...
        <div id="wrapper">
            ...
            <div class="topbar">
                ...
                <div class="topbar-left">
                    <a href="index.html" class="logo"><span>yjticuuy<span>Admin</span></span><i class="mdi mdi-layers"></i></a>
                    <!-- Image logo -->
